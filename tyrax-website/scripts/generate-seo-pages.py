...
NAV = """        <nav class="nav-desktop" aria-label="Навигация">
          <a href="/">Главная</a>
  ...
  <div class="page-wrap">
    <header class="site-header">
      <div class="container header-inner">
        <a href="/" class="logo">
          <img src="/assets/tyrax-icon.png" alt="TYRAX" width="36" height="36">
          TYRAX
        </a>
{NAV}
        <button class="menu-toggle" id="menu-toggle" aria-expanded="false" aria-controls="mobile-nav">MENU</button>
      </div>
    </header>
{MOBILE_NAV}
    <main>
...
PAGES = [
    {
        ...
        "title": "VPN для Windows — скачать TYRAX | Бесплатно 3 ГБ, без рекламы",
        "description": "Скачать VPN для Windows 10/11. TYRAX — нативный клиент с автовыбором сервера, WireGuard/VLESS, 3 ГБ бесплатно без рекламы. VPN для компьютера и ноутбука.",
        "og_title": "VPN для Windows — TYRAX",
        "og_description": "Нативный VPN-клиент для Windows. Автодиагностика, фоновый туннель, 3 ГБ FREE.",
        "h1": "VPN ДЛЯ WINDOWS",
        ...
        "cta_secondary": {"href": "/free.html", "label": "БЕСПЛАТНЫЙ VPN 3 ГБ"},
        ...
        "faq": [
            {"q": "Как скачать VPN для Windows бесплатно?", "a": "Скачайте TYRAX-Setup.exe с tyrax.tech, установите клиент, зарегистрируйтесь — тариф FREE даёт 3 ГБ в месяц без рекламы."},
        ...
        "seo_paragraphs": [
            ...
            "Скачать <strong>VPN для компа</strong> можно напрямую с tyrax.tech — без Microsoft Store. <a href=\"/free.html\">Бесплатный VPN</a> — 3 ГБ/мес. Для iPhone смотрите <a href=\"/vpn-iphone.html\">VPN для iPhone</a>.",
        ],
    },
    {
        "file": "vpn-android.html",
        "breadcrumb": "VPN для Android",
        "title": "VPN для Android — скачать APK TYRAX | Бесплатно 3 ГБ",
        "description": "Скачать VPN для Android (APK). TYRAX — автодиагностика, Wi-Fi/LTE handoff, split tunnel RU, 3 ГБ бесплатно без рекламы.",
        ...
        "features": [
            ...
            {"title": "FREE 3 ГБ", "text": "Бесплатный тариф с полной автоматизацией и всеми серверами. Без рекламы."},
        ],
        "faq": [
            ...
            {"q": "Есть ли бесплатный VPN для телефона?", "a": "Да. TYRAX FREE — 3 ГБ/мес, все серверы, без рекламы. Постоянный тариф, не trial."},
        ...
        "seo_paragraphs": [
            ...
            "Нужен <strong>VPN для телефона бесплатно</strong>? Тариф FREE — <a href=\"/free.html\">3 ГБ без рекламы</a>. Для ПК — <a href=\"/vpn-windows.html\">VPN для Windows</a>.",
        ],
    },
    {
    ...
    },
    {
        ...
        "seo_paragraphs": [
            ...
            "Скачать: <a href=\"/vpn-windows.html\">Windows</a>, <a href=\"/vpn-android.html\">Android</a>. <a href=\"/free.html\">3 ГБ бесплатно</a>.",
        ],
    },
    {
        "file": "no-logs.html",
    ...
    },
    {
        ...
        "features": [
            ...
            {"title": "Лучший бесплатный VPN 2026", "text": "Сравнение free VPN: реклама, лимиты, серверы. Почему TYRAX FREE — 3 ГБ без рекламы. → /blog-luchshiy-besplatnyy-vpn.html"},
    ...
    },
    {
        ...
        "description": "Как скачать и установить VPN на Windows 10/11. TYRAX: загрузка, установка, регистрация, тариф FREE 3 ГБ.",
        ...
        "seo_paragraphs": [
            "Это полноценный <strong>VPN для Windows</strong>, не расширение. <a href=\"/free.html\">3 ГБ бесплатно</a>.",
        ],
    },
    {
        ...
        "description": "Как выбрать бесплатный VPN в 2026: реклама, лимиты, серверы. TYRAX FREE — 3 ГБ/мес, все серверы, zero ads.",
        "og_title": "Лучший бесплатный VPN 2026",
        "og_description": "TYRAX FREE — 3 ГБ без рекламы.",
        "h1": "ЛУЧШИЙ БЕСПЛАТНЫЙ VPN 2026",
        "hero_sub": "Большинство free VPN показывают рекламу или продают данные. TYRAX FREE — 3 ГБ каждый месяц, все серверы, полная автоматизация, ноль рекламы.",
        ...
        "features": [
            ...
            {"title": "3 ГБ/мес навсегда", "text": "Не trial на 7 дней — постоянный бесплатный тариф с ежемесячным обновлением лимита."},
        ],
        "seo_paragraphs": [
    ...
    },
    {
        ...
        "description": "VPN не подключается или медленный: проверка тарифа, лимита FREE 3 ГБ, блокировок, автопротокола TYRAX.",
        ...
        "article": True,
        "features": [
            {"title": "Проверьте лимит FREE", "text": "Тариф FREE — 3 ГБ/мес. При исчерпании лимита подключение недоступно до обновления."},
